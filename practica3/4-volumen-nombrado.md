...
docker run -d --name client-postgres --publish published=9500,target=80 -e PGADMIN_DEFAULT_PASSWORD=12345 -e PGADMIN_DEFAULT_EMAIL=erika.anrrango@epn.edu.ec --network net-drupal dpage/pgadmin4
...
![Configuracion paso 4](capturas/configPaso4.png)
_La instalación puede tomar varios minutos, mientras espera realice un diagrama de los contenedores que ha creado en este apartado._

# COMPLETAR CON EL DIAGRAMA SOLICITADO
![Diagrama de contenedores](capturas/diagramaDrupalPostgres.png)
